...
class CourseClass:
    def __init__(self, root):
        ...
        #====title====
        title= Label(self.root, text= "Manage Course details", font=("goudy old style",20, "bold"), bg= "#033054",fg="white").place(x=10, y=15,width=1275, height= 40)
        ...
        txt_charges= Entry(self.root,textvariable= self.var_duration, font=("goudy old style", 15, "bold"),bg="light yellow").place(x= 150, y=140, width= 200)
        ...
        txt_serach_courseName= Entry(self.root,textvariable=self.var_search, font=("goudy old style", 15, "bold"),bg="light yellow").place(x= 880, y=60,width= 220)
        ...
        try:
            if self.var_course.get()== "":
                ...
                if row== None:
                    ...
                    if op== True:
                        cur.execute("delete from course where name=?,"(self.var.get(),))
                        con.commit()
